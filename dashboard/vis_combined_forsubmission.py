    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /* Prevent cutting at panel edges */
            .viz-panel {
                overflow: visible !important;
                padding: 8px;
            }

            /* Allow plot elements to render naturally */
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Div([
                html.H3("Uncertainty Histogram",
                        style={"margin": "0 0 4px 0", "color": "#0f172a", "fontSize": "clamp(11px, 1.6vw, 13px)"}),
                html.Div(
                    dcc.Graph(id="uncertainty-histogram", style={"height": "100%", "width": "100%"},
        ...
        html.Div([
            html.Div([
                ...
                html.Div(
                    dcc.Graph(id="eeg-graph", style={"height": "100%", "width": "100%"},
                              config={'responsive': True, 'displayModeBar': 'hover'}),
        ...
        html.Div([
            html.Div([
                html.H3("Prediction Flow Across Rounds",
                        style={"margin": "0 0 3px 0", "color": "#0f172a", "fontSize": "clamp(11px, 1.5vw, 12px)"}),
                html.Div(
                    dcc.Graph(id="confusion-heatmap", style={"height": "100%", "width": "100%"},
                              config={'responsive': True}),
                    style={"height": "100%", "width": "100%"}
                ),
            ], className="viz-panel", style={
            ...
            html.Div([
                html.H3("Learning",
                        style={"margin": "0 0 4px 0", "color": "#0f172a", "fontSize": "clamp(11px, 1.6vw, 13px)"}),
                html.Div(
                    dcc.Graph(id="learning-curve", style={"height": "100%", "width": "100%"},
                              config={'responsive': True}),
                    style={"height": "100%", "width": "100%"}
                ),
            ], className="viz-panel", style={
